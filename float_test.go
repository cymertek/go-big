...
func TestFloatMod1(t *testing.T) {
	for _, test := range []struct {
		...
		{"0.875", 0.875},
		{"1.0", 0},
		{"1.0000000000000000000000000000000000002", 0.0000000000000000000000000000000000002},
		{"1.125", 0.125},
		{"1.25", 0.25},
		{"8765.0", 0},
		{"8765.4321", 0.4321},
		{"88888888888888888888888888888888888888888888888888888888765.4321", 0.4321},
		{"88888888888888888888888888888888888888.0000000000000000000000000000000000002", 0.0000000000000000000000000000000000002},
	} {
		x := makeFloat(test.x)
		y := new(Float)
		x.Mod1(y)
...
func TestFloatBytes(t *testing.T) {
	for _, test := range []struct {
		...
		{"-3.456789", -3.456789},
		{"-345678901234000000000000000", -345678901234000000000000000},
		{"0.0000000000000345678901234", 0.0000000000000345678901234},
		{"0.000000000000345678901234", 0.000000000000345678901234},
		{"0.00000000000345678901234", 0.00000000000345678901234},
		{"0.0000000000345678901234", 0.0000000000345678901234},
		{"0.000000000345678901234", 0.000000000345678901234},
		{"0.00000000345678901234", 0.00000000345678901234},
		{"0.0000000345678901234", 0.0000000345678901234},
		{"0.000000345678901234", 0.000000345678901234},
		{"0.00000345678901234", 0.00000345678901234},
		{"0.0000345678901234", 0.0000345678901234},
		{"0.000345678901234", 0.000345678901234},
		{"0.00345678901234", 0.00345678901234},
		{"0.0345678901234", 0.0345678901234},
		{"0.345678901234", 0.345678901234},
		{"3.45678901234", 3.45678901234},
		{"34.5678901234", 34.5678901234},
		{"345.678901234", 345.678901234},
		{"3456.78901234", 3456.78901234},
		{"34567.8901234", 34567.8901234},
		{"345678.901234", 345678.901234},
		{"3456789.01234", 3456789.01234},
		{"34567890.1234", 34567890.1234},
		{"345678901.234", 345678901.234},
		{"3456789012.34", 3456789012.34},
		{"34567890123.4", 34567890123.4},
		{"345678901234", 345678901234},
		{"3456789012340", 3456789012340},
		{"34567890123400", 34567890123400},
		{"345678901234000", 345678901234000},
		{"3456789012340000", 3456789012340000},
		{"34567890123400000", 34567890123400000},
		{"345678901234000000", 345678901234000000},
		{"3456789012340000000", 3456789012340000000},
		{"34567890123400000000", 34567890123400000000},
		{"345678901234000000000", 345678901234000000000},
		{"3456789012340000000000", 3456789012340000000000},
		{"34567890123400000000000", 34567890123400000000000},
		{"345678901234000000000000", 345678901234000000000000},
		{"3456789012340000000000000", 3456789012340000000000000},
		{"34567890123400000000000000", 34567890123400000000000000},
		{"345678901234000000000000000", 345678901234000000000000000},
		{"0.85", 0.85},
		{"0.875", 0.875},
	} {
		...
		f, _ := y.Float64()
		if fmt.Sprintf("%v", f) != fmt.Sprintf("%v", test.s) || !bytes.Equal(a, i.Bytes()) {
			t.Errorf("%s.Bytes() -> SetBytes() = %v; want %v", test.x, f, test.s)
		}
	}
}
